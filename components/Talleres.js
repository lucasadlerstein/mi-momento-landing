            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-xs-12 col-lg-6 text-center mx-auto">
                        ...
                        También te enseñaré ejercicios simples para aliviar rapidamente esos dolores, si te aparecen.`} imagen={'img/taller-cervical.jpg'} />
                    </div>
                    <div className="col-xs-12 col-lg-6 text-center mx-auto">
...
Nunca más una LUMBALGIA.`} imagen={"img/taller-lumbar.jpg"} />
                    </div>
                    <div className="col-xs-12 col-lg-6 text-center mx-auto">
...
Porque si Vos estás bien, también tu Bebé lo estará.`} imagen={"img/mujeres-post-parto.jpg"} />
                    </div>
                    <div className="col-xs-12 col-lg-6 text-center mx-auto">
...
Necesitas fortalecer esa zona  en diferentes posturas. Tonificar toda la musculatura del suelo pélvico, la faja abdominal, la postura y el cuerpo en general. `} imagen={"img/taller-piso-pelvico.jpg"} />
                    </div>
                </div>
            </div>
        </Fondo>
